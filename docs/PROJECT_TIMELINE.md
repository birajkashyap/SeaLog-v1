...
gantt
    ...
    API Design & Architecture   :done, research4, 2025-12-14, 2025-12-19
    ...
    Batching & Processing       :done, backend4, 2026-01-06, 2026-01-18
    Blockchain Integration      :done, backend5, 2026-01-10, 2026-01-23
    
    section Testing & Documentation
    Unit Tests                  :done, test1, 2025-12-26, 2026-01-10
    ...
    Audit UI Development        :planned, frontend1, 2026-02-15, 2026-03-08
    CLI Tools                   :planned, frontend2, 2026-03-01, 2026-03-15
```
